...
namespace anketproje
{
    public partial class Form2 : Form
    {
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            OleDbCommand cmd = new OleDbCommand("Select sorular.soru as soru , secenekler.s1 as s1,secenekler.s2 as s2,secenekler.s3 as s3,secenekler.s4 as s4  From sorular,secenekler WHERE sorular.soru_id=secenekler.soru_idfk AND sorular.soru_id=@soru_id",conn);
